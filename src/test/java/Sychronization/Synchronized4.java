...
public class Synchronized4 {
        ...
        public static void main(String[] args) {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("email"))).sendKeys("mohammad2536@gmail.com");

            wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("password"))).sendKeys("Password@123");
            ...
            String toastText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".Toastify__toast-body > div:last-child"))).getText();
